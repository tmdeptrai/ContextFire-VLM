...
# Load Adapter
adapter_path = "internvl3-2B-finetune"
...
results_df.to_csv('internvl3_2B_FINE_TUNED_results.csv', index=False)
...
plt.title('Confusion Matrix for internvl3_2B_FINE_TUNED')
