...
import numpy as np
from accelerate import Accelerator # New import
...
# MODIFIED for Accelerate: REMOVE device_map. Accelerate will handle it.
...
training_args = SFTConfig(
    output_dir="/dev/shm/qwen2-5-weighted-finetune-native", # Modified output directory
    num_train_epochs=1,
...
wandb.init(project="qwen2.5-3b-instruct-trl-sft-REPORT", name="qwen2.5-3b-instruct-ACCELERATED-WEIGHTED-NATIVE", config=training_args)
...
# Initialize Accelerator outside of SFTTrainer
...
# Prepare model and dataloaders for distributed training with Accelerate
